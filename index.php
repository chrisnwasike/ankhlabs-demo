    ...
    <div class="container">
      ...
      <div class="col-md-12 py-4 mx-auto">
        <div class="row gx-5">
          ...
          <div class="col-md-10 py-1 mx-auto" data-aos="fade-up" style="margin-top: 550px">
            <div class="">
  ...
  <div class="container">
    ...
    <div class="col-md-10 py-4 mx-auto">
      ...
      <div class="row">
        ...
        <div class="col-md-4 p-2 text-center"  data-aos="flip-right">
          <div class="circle my-5 py-5 mx-auto">
            <p class="">Services</p>
          </div>
        </div>

        <div class="col-md-4 p-2 text-center" data-aos="flip-right" data-aos-delay="250">
          <div class="circle my-5 py-5 mx-auto">
            <p class="">Launchpad</p>
          </div>
        </div>

        <div class="col-md-4 p-2 text-center" data-aos="flip-right" data-aos-delay="450">
          <div class="circle my-5 py-5 mx-auto">
            <p class="">Tools</p>
          </div>
        </div>
  ...
  <div class="container three-gods-bg">
    ...
    <div class="col-md-12 py-4 mx-auto">
      ...
      <div class="row">
        ...
        <div class="col-md-4 p-5 text-left" data-aos="fade-up" data-aos-easing="ease-in">
          <div class="my-5 py-5">
  ...
  <div class="container mainservices">
    ...
    <div class="col-md-12 py-4 mx-auto">
      ...
      <div class="row">
        ...
        <div class="col-md-4 p-5 text-left" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="col-md-4 p-5 text-left" data-aos="fade-up" data-aos-delay="500">
          <div class="my-5 onesection d-flex flex-column">
        ...
        <div class="col-md-4 p-5 text-left" data-aos="fade-up" data-aos-delay="700">
          <div class="my-5 onesection d-flex flex-column">
  ...
  <div class="container samplecases">
    ...
    <div class="col-md-12 my-5 my-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4" data-aos="slide-down" data-aos-delay="200">
          <div class="p-5">
        ...
        <div class="col-md-4 mb-4" data-aos="slide-down" data-aos-delay="300">
          <div class="p-5">
        ...
        <div class="col-md-4 mb-4" data-aos="slide-down" data-aos-delay="400">
          <div class="p-5">
  ...
  <div class="container-fluid letswork">
    ...
    <div class="col-md-12 my-5">
      ...
      <div class="row">
        ...
        <div class="col-md-6 p-5" style="background-image: url(img/pitch1.png); background-size:cover;" data-aos="fade-right">
          <div class="row">
            <div class="col-12">
...
<footer class="text-light" data-aos="fade-up">
